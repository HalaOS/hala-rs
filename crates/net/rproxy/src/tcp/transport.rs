...
impl Transport for TcpTransport {
    ...
    fn open_channel(
        &self,
        flag: crate::transport::ChannelOpenFlag,
        max_packet_len: usize,
        cache_queue_len: usize,
    ) -> futures::prelude::future::BoxFuture<
        'static,
        std::io::Result<crate::transport::TransportChannel>,
    > {
        Box::pin(async move {
            ...
            event_loops::start_event_loop(flag, rhs_channel);
...
mod event_loops {
    ...
    use super::*;
    pub(super) fn start_event_loop(flag: ChannelOpenFlag, channel: TransportChannel) {
    ...
    fn create_conn(flag: &ChannelOpenFlag) -> io::Result<TcpStream> {
        match flag {
            ChannelOpenFlag::RemoteAddresses(raddrs) => TcpStream::connect(raddrs.as_slice()),
            ChannelOpenFlag::RemoteAddress(raddr) => TcpStream::connect(raddr),
            _ => Err(io::Error::new(
