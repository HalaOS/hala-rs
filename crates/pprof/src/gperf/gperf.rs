...
pub struct Line {
    ...
    pub line: i64,
    // @@protoc_insertion_point(field:perftools.profiles.Line.column)
    pub column: i64,
    // special fields
...
impl ::protobuf::Message for Line {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.column != 0 {
            my_size += ::protobuf::rt::int64_size(3, self.column);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    R\x04line\x12\x1b\n\tis_folded\x18\x05\x20\x01(\x08R\x08isFolded\"S\n\
    \x04Line\x12\x1f\n\x0bfunction_id\x18\x01\x20\x01(\x04R\nfunctionId\x12\
    \x12\n\x04line\x18\x02\x20\x01(\x03R\x04line\x12\x16\n\x06column\x18\x03\
    \x20\x01(\x03R\x06column\"\x8a\x01\n\x08Function\x12\x0e\n\x02id\x18\x01\
    \x20\x01(\x04R\x02id\x12\x12\n\x04name\x18\x02\x20\x01(\x03R\x04name\x12\
    \x1f\n\x0bsystem_name\x18\x03\x20\x01(\x03R\nsystemName\x12\x1a\n\x08fil\
    ename\x18\x04\x20\x01(\x03R\x08filename\x12\x1d\n\nstart_line\x18\x05\
    \x20\x01(\x03R\tstartLineB-\n\x1dcom.google.perftools.profilesB\x0cProfi\
    leProtob\x06proto3\
";
