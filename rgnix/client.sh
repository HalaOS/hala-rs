...
nohup cargo run --example rproxy -- --laddrs 0.0.0.0:1812 -g tcp -t quic --peer-domain 127.0.0.1 --peer-port-range 1813 --tunnel-ca-file ./cert/hala_ca.pem --verify-server --tunnel-cert-chain-file ./cert/client.crt --tunnel-key-file ./cert/client.key > client.log &
